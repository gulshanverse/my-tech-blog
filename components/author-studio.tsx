...
type Props = { initialView?: "dashboard" | "editor"; initialPath?: string; initialPathError?: string };
...
export function AuthorStudio({ initialView = "dashboard", initialPath = "", initialPathError = "" }: Props) {
