...
<Warning>A spinner that never resolves is not a neutral state—it is an ambiguous one. Make the failure state visible and give the reader a clear next action.</Warning>
