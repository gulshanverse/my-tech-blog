...
> **Tip:** Save the source filename, heading path, and character range with every chunk. When a result is wrong, provenance turns a vague failure into a debuggable one.
