...
export const projects: Project[] = [
  {
    ...
    "architecture": [
      "Typed route and search state",
      "Server-rendered content surfaces",
      "Composable UI primitives",
      "Data layer ready for live integrations"
    ],
    "features": [
      "Journey-first information hierarchy",
      "Responsive mobile flow",
      "Reusable trip summary components",
  ...
  },
  {
    ...
    "architecture": [
      "Profile and interest model",
      "Searchable project briefs",
      "Simple moderation boundary",
